...
namespace RecipeManager.Identity.Api.Persistance.Migrations
{
    ...
    [Migration("20251026212319_AddRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeManager.Identity.Api.Domain.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RecipeManager.Identity.Api.Domain.RefreshToken", b =>
                {
                    b.HasOne("RecipeManager.Identity.Api.Domain.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
