...
namespace RecipeManager.Api.Persistance.Migrations
{
    ...
    [Migration("20251222214522_AddIngredientPackage")]
    partial class AddIngredientPackage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeManager.Api.Domain.Ingredients.IngredientPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<Guid>("PackageSizeUnitId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PackageSizeUnitId");

                    b.HasIndex("PackageUnitId");

                    b.ToTable("IngredientPackage", (string)null);
                });
            ...
            modelBuilder.Entity("RecipeManager.Api.Domain.Ingredients.IngredientPackage", b =>
                {
                    b.HasOne("RecipeManager.Api.Domain.Ingredients.Ingredient", null)
                        .WithOne("IngredientPackage")
                        .HasForeignKey("RecipeManager.Api.Domain.Ingredients.IngredientPackage", "IngredientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecipeManager.Api.Domain.Units.Unit", null)
                        .WithMany()
                        .HasForeignKey("PackageSizeUnitId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("RecipeManager.Api.Domain.Ingredients.Ingredient", b =>
                {
                    b.Navigation("IngredientPackage")
                        .IsRequired();
